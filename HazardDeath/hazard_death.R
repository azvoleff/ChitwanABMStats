...
plot(deathhazard, type="s", xlab="Age (years)", ylab="Hazard of death", main="Chitwan valley death hazard")
...
hist(statusage, breaks=20, xlab="Age of last observation (years)", main="Chitwan Valley, age at status")
...
write(t(deathhazard), file="death_hazard.txt", ncolumns=ncol(deathhazard), sep=",")
