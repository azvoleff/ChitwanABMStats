...
save(LDmigrations.merged, file=paste("migrations_wideformat-", MONTHS.AWAY, "_months_away.Rdata", sep=""))
...
save(LDmigrations.long, file=paste("migrations_longformat-", MONTHS.AWAY, "_months_away.Rdata", sep=""))
