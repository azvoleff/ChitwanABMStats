...
nfo.areas <- read.csv("nfo_areas_T3_sq_meters.csv")
...
ggsave("nfo_areas_T3_hist_cut.png", width=8.33, height=5.53, dpi=300)

qplot(area, facets=nfo_type~., geom="histogram", xlim=c(0, 10000),
        xlab="NFO Area (square meters)", ylab="Count", data=nfo.areas)
ggsave("nfo_areas_T3_hist_type.png", width=8.33, height=5.53, dpi=300)
...
qplot(binlims, prob*100, geom="step", xlab="NFO Area (square meters)",
        ylab="Probability")
ggsave("nfo_areas_T3_hist_prob.png", width=8.33, height=5.53, dpi=300)
